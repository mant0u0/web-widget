...
const TextEditor = () => {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center overflow-hidden">
      {/* content  */}
      <div className="flex h-full w-full flex-col gap-2 overflow-hidden p-2 md:flex-row-reverse md:gap-3 md:p-3">
        ...
        <div className="h-[60%] w-full overflow-hidden md:h-full md:w-[25%] md:min-w-[380px]">
          <Toolbar
            text={text}
